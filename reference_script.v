"""
================================================================================
MOBILENETV2 INFERENCE - CPU VERIFICATION
================================================================================
"""
...
# =====================================================================
# CPU MAC (replaces FPGA HardwareMAC3x3)
# =====================================================================
class HardwareMAC3x3:
    def __init__(self, bitstream_path):
        print("[CPU] NumPy MAC engine ready")

    def run_mac(self, inputs, weights):
        x = np.asarray(inputs, dtype=np.int32).flatten()
        y = np.asarray(weights, dtype=np.int32).flatten()
...
def main():
    print("=" * 70)
    print("MOBILENETV2 INFERENCE - CPU VERIFICATION")
    print("=" * 70)
    ...
    model = MobileNetV2_HW(WEIGHT_DIR, "./dummy.bit")
